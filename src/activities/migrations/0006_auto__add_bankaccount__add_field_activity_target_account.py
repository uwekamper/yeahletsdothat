...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'activities_bankaccount', (
        ...
        db.send_create_signal(u'activities', ['BankAccount'])

        # Adding field 'Activity.target_account'
        db.add_column(u'activities_activity', 'target_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.BankAccount'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BankAccount'
        db.delete_table(u'activities_bankaccount')

        # Deleting field 'Activity.target_account'
        db.delete_column(u'activities_activity', 'target_account_id')
