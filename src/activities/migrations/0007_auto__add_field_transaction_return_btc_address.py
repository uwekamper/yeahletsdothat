...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.return_btc_address'
        db.add_column(u'activities_transaction', 'return_btc_address',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.return_btc_address'
        db.delete_column(u'activities_transaction', 'return_btc_address')
