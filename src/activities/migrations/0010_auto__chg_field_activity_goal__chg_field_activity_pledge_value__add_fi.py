...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.goal'
        db.alter_column(u'activities_activity', 'goal', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=8))

        # Changing field 'Activity.pledge_value'
        db.alter_column(u'activities_activity', 'pledge_value', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=8))
        # Adding field 'Transaction.amount'
        db.add_column(u'activities_transaction', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8),
                      keep_default=False)

        # Adding field 'Transaction.btc_address'
        db.add_column(u'activities_transaction', 'btc_address',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.email'
        db.add_column(u'activities_transaction', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=1024, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Activity.goal'
        db.alter_column(u'activities_activity', 'goal', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Activity.pledge_value'
        db.alter_column(u'activities_activity', 'pledge_value', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
        # Deleting field 'Transaction.amount'
        db.delete_column(u'activities_transaction', 'amount')

        # Deleting field 'Transaction.btc_address'
        db.delete_column(u'activities_transaction', 'btc_address')

        # Deleting field 'Transaction.email'
        db.delete_column(u'activities_transaction', 'email')
