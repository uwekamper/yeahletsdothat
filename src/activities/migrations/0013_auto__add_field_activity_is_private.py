...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.is_private'
        db.add_column(u'activities_activity', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.is_private'
        db.delete_column(u'activities_activity', 'is_private')


    models = {
        u'activities.activity': {
            'Meta': {'object_name': 'Activity'},
            'code': ('django.db.models.fields.CharField', [], {'default': "'TgO8OPcyA6SQjzCx'", 'max_length': '16'}),
