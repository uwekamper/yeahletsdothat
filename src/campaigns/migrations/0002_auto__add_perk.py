...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Perk'
        db.create_table(u'campaigns_perk', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('test', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=8)),
            ('currency', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'campaigns', ['Perk'])


    def backwards(self, orm):
        # Deleting model 'Perk'
        db.delete_table(u'campaigns_perk')
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'NUS2T6v_RAJcqdGY'", 'max_length': '16', 'null': 'True'}),
