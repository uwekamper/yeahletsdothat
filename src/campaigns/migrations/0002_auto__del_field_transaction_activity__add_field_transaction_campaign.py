...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'campaigns_transaction', 'activity', 'campaign')

    def backwards(self, orm):
        db.rename_column(u'campaigns_transaction', 'campaign', 'activity')
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'jM8gMYAsGaGtgJNP'", 'max_length': '16', 'null': 'True'}),
