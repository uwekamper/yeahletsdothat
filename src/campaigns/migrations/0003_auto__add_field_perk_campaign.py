...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Perk.campaign'
        db.add_column(u'campaigns_perk', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['campaigns.Campaign']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Perk.campaign'
        db.delete_column(u'campaigns_perk', 'campaign_id')
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'yokv-laA5bv0VMb7'", 'max_length': '16', 'null': 'True'}),
