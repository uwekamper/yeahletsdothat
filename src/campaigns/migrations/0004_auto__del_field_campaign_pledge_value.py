...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.pledge_value'
        db.delete_column(u'campaigns_campaign', 'pledge_value')


    def backwards(self, orm):
        # Adding field 'Campaign.pledge_value'
        db.add_column(u'campaigns_campaign', 'pledge_value',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=8),
                      keep_default=False)
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'kFeEjkPGOpw0c89Y'", 'max_length': '16', 'null': 'True'}),
