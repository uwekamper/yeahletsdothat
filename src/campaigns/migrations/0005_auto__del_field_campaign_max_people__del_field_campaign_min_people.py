...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.max_people'
        db.delete_column(u'campaigns_campaign', 'max_people')

        # Deleting field 'Campaign.min_people'
        db.delete_column(u'campaigns_campaign', 'min_people')


    def backwards(self, orm):
        # Adding field 'Campaign.max_people'
        db.add_column(u'campaigns_campaign', 'max_people',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Campaign.min_people'
        db.add_column(u'campaigns_campaign', 'min_people',
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'Z8V2CBNDa1F7erJ5'", 'max_length': '16', 'null': 'True'}),
