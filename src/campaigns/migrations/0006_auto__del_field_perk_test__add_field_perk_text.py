...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Perk.test'
        # db.delete_column(u'campaigns_perk', 'test')
        #
        # # Adding field 'Perk.text'
        # db.add_column(u'campaigns_perk', 'text',
        #               self.gf('django.db.models.fields.TextField')(null=True, blank=True),
        #               keep_default=False)

        db.rename_column(u'campaigns_perk', 'test', 'text')


    def backwards(self, orm):
        # Adding field 'Perk.test'
        # db.add_column(u'campaigns_perk', 'test',
        #               self.gf('django.db.models.fields.TextField')(null=True, blank=True),
        #               keep_default=False)

        # Deleting field 'Perk.text'
        # db.delete_column(u'campaigns_perk', 'text')

        db.rename_column(u'campaigns_perk', 'text', 'test')
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'SbxNj9rnslfF-kxg'", 'max_length': '16', 'null': 'True'}),
