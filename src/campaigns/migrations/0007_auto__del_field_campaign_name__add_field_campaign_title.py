...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # db.delete_column(u'campaigns_campaign', 'name')
        #
        # # Adding field 'Campaign.title'
        # db.add_column(u'campaigns_campaign', 'title',
        #               self.gf('django.db.models.fields.CharField')(default='test', max_length=200),
        #               keep_default=False)
        #
        db.rename_column(u'campaigns_campaign', 'name', 'title')

    def backwards(self, orm):
        # Adding field 'Campaign.name'
        # db.add_column(u'campaigns_campaign', 'name',
        #               self.gf('django.db.models.fields.CharField')(default='test', max_length=200),
        #               keep_default=False)

        # Deleting field 'Campaign.title'
        # db.delete_column(u'campaigns_campaign', 'title')

        db.rename_column(u'campaigns_campaign', 'title', 'name')
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'7KSCx7VWkIoTfQr3'", 'max_length': '16', 'null': 'True'}),
