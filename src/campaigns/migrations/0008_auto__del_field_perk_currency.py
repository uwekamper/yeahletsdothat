...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Perk.currency'
        db.delete_column(u'campaigns_perk', 'currency')


    def backwards(self, orm):
        # Adding field 'Perk.currency'
        db.add_column(u'campaigns_perk', 'currency',
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'A3yGQlibZh2Ox4OW'", 'max_length': '16', 'null': 'True'}),
