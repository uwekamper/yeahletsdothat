...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Events'
        db.create_table(u'campaigns_events', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('data', self.gf(u'django_hstore.fields.DictionaryField')()),
        ))
        db.send_create_signal(u'campaigns', ['Events'])


        # Changing field 'Perk.amount'
        db.alter_column(u'campaigns_perk', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8))

    def backwards(self, orm):
        # Deleting model 'Events'
        db.delete_table(u'campaigns_events')


        # Changing field 'Perk.amount'
        db.alter_column(u'campaigns_perk', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=8))
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'XTu7odyFtUuONpF2'", 'max_length': '16', 'null': 'True'}),
        ...
        u'campaigns.perk': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '8'}),
