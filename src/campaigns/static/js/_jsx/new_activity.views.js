        ...
        return(
            React.DOM.form( {role:"form"}, 
                React.DOM.div( {className:"form-group"}, 
                    React.DOM.label( {for:"id_title"}, "Title"),
                    React.DOM.input( {type:"email", className:"form-control", id:"id_title", placeholder:""} )
                ),
                React.DOM.div( {className:"form-group"}, 
                    React.DOM.label( {for:"id_description"}, "Description"),
                    React.DOM.input( {type:"email", className:"form-control", id:"id_description", placeholder:""} )
                ),
